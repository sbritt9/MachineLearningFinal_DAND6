...
""" a basic script for importing student's POI identifier,
    ...
    that process should happen at the end of OLD_DoNotUse_poi_id.py
"""
...
def test_classifier(clf, dataset, feature_list, folds = 1000):
    ...
    cv = StratifiedShuffleSplit(random_state = 42, test_size=.3, n_splits=folds)
    true_negatives = 0
    false_negatives = 0
    true_positives = 0
    false_positives = 0
...
# the method below was edited to change the open parameter from "w" to "wb"
